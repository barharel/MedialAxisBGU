...
public class PhaseTwoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        {
            case R.id.triangle:
                pictureButtonClick(11);
                break;

            case R.id.two_rectangles:
                pictureButtonClick(12);
                break;

            case R.id.rectangle:
                pictureButtonClick(13);
                break;

            case R.id.rectangle_missing:
                pictureButtonClick(14);
                break;

            case R.id.rectangle_missing_2:
                pictureButtonClick(15);
                break;

            case R.id.circle:
                pictureButtonClick(16);
                break;
        }
    }

    private void pictureButtonClick(int id){
        Intent intent = new Intent(PhaseTwoActivity.this, ShapeActivity.class);
        Bundle b = new Bundle();
        b.putInt("key",id);
        intent.putExtras(b);
